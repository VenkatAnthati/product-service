...
@Service
public class EmployeePDFGeneratoryImpl implements EmployeePdfGeneratorService {
	...
	@Override
	public void preparetable() throws FileNotFoundException, DocumentException {
		Document document = new Document();
		
		PdfWriter.getInstance(document, new FileOutputStream("C:\\Users\\VenkateswaraRaoAntha\\Downloads\\table.pdf"));
		document.open();
		Font bold = new Font(FontFamily.HELVETICA, 12, Font.BOLD);
		Paragraph preface = new Paragraph("IBM Privat Ltd.",bold); 
		//preface.add("IBM Privat Ltd.",bold);
		preface.setAlignment(Element.ALIGN_CENTER);
		document.add(preface);
		Paragraph preface1 = new Paragraph();
		preface1.add("Hyderabad, telanga, 500090.");
